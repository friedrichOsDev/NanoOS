...
#define LAPIC_REG_ICR_LOW  0x0300 // LAPIC Interrupt Command Register (low) offset
#define LAPIC_REG_ICR_HIGH 0x0310 // LAPIC Interrupt Command Register (high) offset
...
#define IOAPIC_REG_RED_TABLE(idx) (0x10 + (idx) * 2) // Redirection Entry for IRQ idx (64-bit)
