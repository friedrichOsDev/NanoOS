...
typedef struct {
    ...
    uint8_t  status_low:3;  // Status register bits 0-2
    uint8_t  rsvd1:1;       // Reserved
    uint8_t  status_high:3; // Status register bits 4-6
...
/**
 * @brief HBA Physical Region Descriptor Table Entry
 */
typedef struct {
